...
const mockBurnHistory = [
  { id: 1, date: '2023-12-01', token: 'BONK', amount: '500,000', value: '$10.00', credits: '12.00' },
          ...
          {showSuccess ? (
            ...
            >
              <div className="flex items-center justify-center flex-col text-center py-4">
                ...
                <p className="mb-4">You earned <span className="font-bold">{earnedCredits}</span> credits</p>
                <button 
                  ...
                  {burnAmount && (
                    ...
                    >
                      ...
                      <p className="text-xs text-ash-500 dark:text-ash-400">
                        Rate: {tokens.find(t => t.symbol === selectedToken)?.creditRate.toFixed(1)}x credits per dollar value
                      </p>
                    </motion.div>
                  )}
                </motion.div>
